-- =============================================================
-- DigiTech Company Profile â€“ MySQL Schema
...
INSERT INTO layanan (nama, icon, deskripsi, urutan) VALUES
  ...
  ('Custom Software', 'layers',  'Pengembangan aplikasi web dan mobile yang disesuaikan penuh dengan kebutuhan bisnis Anda â€” dari ideasi hingga deployment production.',                                                      4),
